...
// GetByMacAddress provides a mock function for the type MockDeviceRepository
func (_mock *MockDeviceRepository) GetByMacAddress(ctx context.Context, macAddress string) (*entities.Device, error) {
	ret := _mock.Called(ctx, macAddress)

	if len(ret) == 0 {
		panic("no return value specified for GetByMacAddress")
	}
...
// MockDeviceRepository_GetByMacAddress_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetByMacAddress'
type MockDeviceRepository_GetByMacAddress_Call struct {
	*mock.Call
}

// GetByMacAddress is a helper method to define mock.On call
//   - ctx context.Context
//   - macAddress string
func (_e *MockDeviceRepository_Expecter) GetByMacAddress(ctx interface{}, macAddress interface{}) *MockDeviceRepository_GetByMacAddress_Call {
	return &MockDeviceRepository_GetByMacAddress_Call{Call: _e.mock.On("GetByMacAddress", ctx, macAddress)}
}

func (_c *MockDeviceRepository_GetByMacAddress_Call) Run(run func(ctx context.Context, macAddress string)) *MockDeviceRepository_GetByMacAddress_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockDeviceRepository_GetByMacAddress_Call) Return(device *entities.Device, err error) *MockDeviceRepository_GetByMacAddress_Call {
	_c.Call.Return(device, err)
	return _c
}

func (_c *MockDeviceRepository_GetByMacAddress_Call) RunAndReturn(run func(ctx context.Context, macAddress string) (*entities.Device, error)) *MockDeviceRepository_GetByMacAddress_Call {
	_c.Call.Return(run)
	return _c
}

// List provides a mock function for the type MockDeviceRepository
func (_mock *MockDeviceRepository) List(ctx context.Context, limit int, offset int) ([]*entities.Device, error) {
...
//   - limit int
//   - offset int
func (_e *MockDeviceRepository_Expecter) List(ctx interface{}, limit interface{}, offset interface{}) *MockDeviceRepository_List_Call {
	return &MockDeviceRepository_List_Call{Call: _e.mock.On("List", ctx, limit, offset)}
}

func (_c *MockDeviceRepository_List_Call) Run(run func(ctx context.Context, limit int, offset int)) *MockDeviceRepository_List_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockDeviceRepository_List_Call) RunAndReturn(run func(ctx context.Context, limit int, offset int) ([]*entities.Device, error)) *MockDeviceRepository_List_Call {
	_c.Call.Return(run)
	return _c
}
